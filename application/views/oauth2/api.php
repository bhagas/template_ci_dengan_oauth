...
$(document).ready(function(){
    $("#btn-refresh").click(function (e){
        var data = {refresh_token: $("#old_token").val(), client_id: 'testid', client_secret:'testid', grant_type:'refresh_token', scope:'userinfo'};
        
        $.post('RefreshToken', data, function (d){
    ...
    $('#btn-authorize').click(function (e){
        var data = {code: $("#authorize-code").val(), client_id: 'testid', client_secret:'testid', redirect_uri:"http://localhost/master-backoffice/index.php/oauth2/authorize", grant_type: 'authorization_code', scope:'userinfo'};
        $.post('authorize/token', data, function (d){
    ...
    $('#btn-resource').click(function (e){
        var data = { access_token: $("#resource").val(), coba: "ya"};
    ...
    $('#btn-resource-limit').click(function (e){
        ...
        $.post('resource/limit', data, function (d){
            console.log("Get Authorize => ", d);
            $('#return-resource').html(JSON.stringify(d));
        },"json");      
    });
    ...
    $('#btn-PasswordCredentials').click(function (e){
        var data = { grant_type: "password", username: "user", password: "pass", client_id: 'testid', client_secret:'testid', scope:'userinfo' };
        $.post('PasswordCredentials', data, function (d){
            console.log('asu');
    ...
    $("#btn-ClientCredentials").click(function (e){
        var data = {client_id: 'testid', client_secret:'testid', grant_type:'client_credentials', scope:'userinfo'};
        $.post('ClientCredentials', data, function (d){
            //d = d.JSON.parse(d);
