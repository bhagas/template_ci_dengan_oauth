...
// Adapters
include(APPPATH.'libraries/geoPHP/lib/adapters/GeoAdapter.class.php'); // Abtract class
include(APPPATH.'libraries/geoPHP/lib/adapters/GeoJSON.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/WKT.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/EWKT.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/WKB.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/EWKB.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/KML.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/GPX.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/GeoRSS.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/GoogleGeocode.class.php');
include(APPPATH.'libraries/geoPHP/lib/adapters/GeoHash.class.php');

// Geometries
include(APPPATH.'libraries/geoPHP/lib/geometry/Geometry.class.php'); // Abtract class
include(APPPATH.'libraries/geoPHP/lib/geometry/Point.class.php');
include(APPPATH.'libraries/geoPHP/lib/geometry/Collection.class.php'); // Abtract class
include(APPPATH.'libraries/geoPHP/lib/geometry/LineString.class.php');
include(APPPATH.'libraries/geoPHP/lib/geometry/MultiPoint.class.php');
include(APPPATH.'libraries/geoPHP/lib/geometry/Polygon.class.php');
include(APPPATH.'libraries/geoPHP/lib/geometry/MultiLineString.class.php');
include(APPPATH.'libraries/geoPHP/lib/geometry/MultiPolygon.class.php');
include(APPPATH.'libraries/geoPHP/lib/geometry/GeometryCollection.class.php');
...
class Geophp
{
  ...
  public function wkb_to_json($wkb) {
    $geom = $this->load($wkb,'wkb');
