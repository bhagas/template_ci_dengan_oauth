...
(function() {
	...
	L.Routing.Itinerary = L.Control.extend({
		...
		options: {
			...
			summaryTemplate: '<h3>{name}</h3><h4>{distance}, {time}</h4>',
			timeTemplate: '{time}',
			containerClassName: '',
		...
		'en': {
			...
			instructions: {
				...
				'Continue':
					['Lurus {dir}', ' ke {road}'],
				'SlightRight':
					['Serong kanan', ' menuju {road}'],
				'Right':
					['Kanan', ' menuju {road}'],
				'SharpRight':
					['Putar kanan', ' menuju {road}'],
				'TurnAround':
					['Putar'],
				'SharpLeft':
					['Putar kiri', ' menuju {road}'],
				'Left':
					['Kiri', ' menuju {road}'],
				'SlightLeft':
					['Serong kiri', ' menuju {road}'],
				'WaypointReached':
					['Waypoint reached'],
				'Roundabout':
					['Ambil {exitStr} exit di roundabout', ' Ambil {road}'],
				'DestinationReached':
					['Sampai Tujuan'],
			},
