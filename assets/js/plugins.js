...
function iosSwitch() {
    if ($('.js-switch').length){ 
        setTimeout(function(){
            ...
            if(colorOn == 'green') colorOn = '#2ecc71';
            ...
            if(colorOff == 'green') colorOff = '#2ecc71';
...
function barCharts() {
    if ($('.bar-stats').length) {
        $('.bar-stats').each(function () {
            ...
            var custom_colors =['#C9625F', '#2ecc71', '#90ed7d', '#f7a35c', '#8085e9', '#f15c80', '#8085e8', '#91e8e1'];
